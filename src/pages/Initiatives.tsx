		...
		<section className="relative w-full bg-gradient-to-br from-white via-[#ebe7d9] to-[#e2c5a9] px-6 py-40">
			...
			>
				...
				<p className="text-lg text-[#858d6a] max-w-3xl mx-auto mb-16">
					Every initiative we take is an opportunity to give back to
					our planet. These efforts aren’t just projects—they’re
					movements driven by passion, responsibility, and youth-led
					energy.
				</p>
