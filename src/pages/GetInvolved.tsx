...
const GetInvolved = () => {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		if (!isLogin && formData.role === "STUDENT") {
			if (
				!formData.parent_1_name ||
				!formData.parent_1_email ||
				!formData.parent_1_phone
			) {
				alert(
					"Please provide Parent 1 Name, Email, and Phone (required for students)."
				);
				return;
			}
		}
				...
				const insertPayload = {
					...
					parent_1_name:
						formData.role === "STUDENT"
							? formData.parent_1_name || null
							: null,
					parent_1_email:
						formData.role === "STUDENT"
							? formData.parent_1_email || null
							: null,
					parent_1_phone:
						formData.role === "STUDENT"
							? formData.parent_1_phone || null
							: null,
					parent_2_name:
						formData.role === "STUDENT"
							? formData.parent_2_name || null
							: null,
					parent_2_email:
						formData.role === "STUDENT"
							? formData.parent_2_email || null
							: null,
					parent_2_phone:
						formData.role === "STUDENT"
							? formData.parent_2_phone || null
							: null,
					status: "PENDING",
				};
