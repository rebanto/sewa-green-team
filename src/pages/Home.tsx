		...
		>
			...
			>
				...
				<p className="text-[#c27d50] mb-10 text-lg max-w-3xl mx-auto">
					Sewa Green Team is a youth-powered environmental force
					reshaping communities through cleanups, education, and green
					action.
				</p>
			...
			>
				<div className="max-w-5xl mx-auto text-center">
					<h2 className="text-3xl font-bold text-[#c27d50] mb-4">
						🌱 Recent Impact
					</h2>
					<p className="text-[#6c7358] mb-8">
						These aren’t just events — they’re movements creating
						lasting change.
					</p>
					<FeaturedEvent />
					<Link
